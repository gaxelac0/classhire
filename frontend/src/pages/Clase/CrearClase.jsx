          ...
          >
            <Box px={[4, 0]}>
              ...
              <Text mt={1} fontSize="sm" color="gray.600">
                La informacion provista en estos formularios estara disponible a
                traves de nuestra plataforma para que estudiantes de todo el
                globo puedan contactarse contigo y acceder a tus clases.
              </Text>
            </Box>
              ...
              >
                ...
                <div>
                  <FormControl mt={1} isInvalid={isErrorDescription} isRequired>
                    ...
                    />
                    <FormHelperText>
                      Detalla una descripcion acerca de la clase, contenidos
                      minimos, etc.
                    </FormHelperText>
                    {isErrorDescription && (
                      <FormErrorMessage>
                        La descripcion de la clase es requerida.
                      </FormErrorMessage>
                    )}
                  </FormControl>
                </div>
                ...
                >
                  ...
                  <InputGroup>
                    <InputLeftAddon bg="gray.100" color="gray.500" rounded="md">
                      AR$
                    </InputLeftAddon>
                    <Input
                      type="number"
                  ...
                  {isErrorPrice && (
                    <FormErrorMessage>
                      El precio de la clase es requerido.
                    </FormErrorMessage>
                  )}
                </FormControl>
                ...
                >
                  ...
                  {isErrorDuration && (
                    <FormErrorMessage>
                      El ingreso de la duracion de la clase es obligatorio
                    </FormErrorMessage>
                  )}
                </FormControl>
                ...
                >
                  ...
                  >
                    ...
                    <option id="secundaria" value={"secundaria"}>
                      Secundaria
                    </option>
                    <option id="terciaria" value={"terciaria"}>
                      Terciario
                    </option>
                    <option id="universitario" value={"universitario"}>
                      Universitario
                    </option>
                    <option id="seminario" value={"seminario"}>
                      Seminario
                    </option>
                  </Select>
                  {isErrorDuration && (
                    <FormErrorMessage>
                      El nivel de la clase es requerido
                    </FormErrorMessage>
                  )}
                </FormControl>
                ...
                >
                  ...
                  {isErrorFrecuencia && (
                    <FormErrorMessage>
                      la frecuencia de la clase es requerida
                    </FormErrorMessage>
                  )}
                </FormControl>
                ...
                >
                  ...
                  >
                    ...
                    <option id="grupal" value={"grupal"}>
                      Grupal
                    </option>
                    <option id="consulta" value={"consulta"}>
                      Consulta
                    </option>
                  </Select>
                  {isErrorTipoClase && (
                ...
                <FormControl as={GridItem} colSpan={[3, 2]}>
                  <FormLabel fontSize="sm" fontWeight="md" color="gray.500">
                    Etiquetas
                  </FormLabel>
                  <InputGroup>
                    <InputLeftAddon bg="gray.100" color="gray.500" rounded="md">
                  ...
                  <FormHelperText>
                    Etiquetas que identifican tu clase. Pon todas las que
                    quieras separadas con coma!
                  </FormHelperText>
                </FormControl>
              </Stack>
              <Box
...
const CrearClase = (props) => {
  return (
    <BackgroundLayout component={<CrearClaseComponent />}></BackgroundLayout>
  );
};
